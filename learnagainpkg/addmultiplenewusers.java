...
public class addmultiplenewusers {
	WebDriver driver;	
	@BeforeClass
	...
	public String generateRandomString() {
	    return "testeragent7+" + new BigInteger(120, new SecureRandom()).toString(32) + "@gmail.com";
	}
	@Test(dependsOnMethods= "registerpageopen")
	public void registeruser() {
		System.out.println("going to register a new user");
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div[2]/div[2]/div/ul/li/div/form/div[1]/input")).sendKeys(generateRandomString());
